  ...
  projectCardListArray.forEach(function (card) {
    card.addEventListener("mouseenter", function (event) {
      ...
      selectedCard.querySelector(
        ".project-icons"
      ).firstElementChild.style.pointerEvents = "auto";
      selectedCard.querySelector(
        ".project-icons"
      ).lastElementChild.style.pointerEvents = "auto";
    });
    card.addEventListener("mouseleave", function (event) {
      ...
      selectedCard.querySelector(
        ".project-icons"
      ).lastElementChild.style.pointerEvents = "none";
    });
  });
...
var findSectionPositions = function findSectionPositions() {
  ...
  contactScrollPosition =
    document.querySelector("#contact").offsetTop - headerHeight; // console.log("Section Positions Calculated")
};
...
var navScrollListener = function navScrollListener() {
  ...
  var navColorDetect = function navColorDetect() {
    ...
    if (
      screenPosition > homeScrollPosition &&
      !homeNav.classList.contains("active-link-section") &&
      ...
      !projectsNav.classList.contains("active-link-section")
    ) {
      colorClear(navArray);
      projectsNav.classList.add("active-link-section");
    } else if (
      window.innerHeight + window.pageYOffset >= document.body.offsetHeight &&
      !contactNav.classList.contains("active-link-section")
    ) {
      colorClear(navArray);
